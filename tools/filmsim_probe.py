...
STOCKS = [
    ...
    ("heritage_gold",     "ColorNegative",   200,  1.13,  0.22,  0.36,  1.21,  0.17, -0.02,  0.08,  0.02, -0.08,  0.24,  0.07,  0.19),
    ("porcelain_400",     "ColorNegative",   400,  0.92,  0.29,  0.67,  0.97,  0.11,  0.08,  0.05,  0.00, -0.05,  0.22,  0.04,  0.10),
    ("vivid_chrome",      "Reversal",         50,  1.32,  0.07,  0.10,  1.46, -0.01, -0.05,  0.00,  0.02, -0.01,  0.10,  0.01,  0.31),
    ("arctic",            "Reversal",        100,  1.19,  0.09,  0.15,  1.22, -0.16, -0.02, -0.08,  0.01,  0.10,  0.14,  0.01,  0.24),
    ("sovereign",         "ColorNegative",   160,  1.09,  0.19,  0.33,  1.09,  0.03,  0.00,  0.02,  0.01, -0.02,  0.18,  0.03,  0.19),
    ("golden_hour",       "ColorNegative",   200,  0.98,  0.26,  0.48,  1.05,  0.29, -0.08,  0.12,  0.04, -0.12,  0.22,  0.09,  0.10),
    ("twilight_160",      "MotionNegative",  160,  0.99,  0.21,  0.56,  1.00,  0.20,  0.05,  0.07,  0.01, -0.07,  0.20,  0.06,  0.12),
    ("nostalgia_200",     "ColorNegative",   200,  0.92,  0.33,  0.50,  0.70,  0.07, -0.16,  0.03,  0.07, -0.04,  0.34,  0.05,  0.06),
    ("desert_chrome",     "Reversal",         64,  1.22,  0.11,  0.14,  1.34,  0.20, -0.04,  0.10,  0.05, -0.11,  0.12,  0.02,  0.26),
    ("street_800",        "ColorNegative",   800,  1.19,  0.31,  0.42,  0.76, -0.01,  0.04, -0.01,  0.01,  0.01,  0.60,  0.05,  0.28),
    ("cinematic_500t",    "MotionNegative",  500,  0.92,  0.26,  0.64,  0.79, -0.16, -0.10, -0.08,  0.02,  0.11,  0.30,  0.30,  0.08),
    ("fade_bloom",        "Creative",        200,  0.79,  0.49,  0.63,  0.52,  0.03,  0.22,  0.03, -0.03,  0.00,  0.39,  0.24,  0.03),
    ("ember",             "Creative",        400,  1.19,  0.21,  0.35,  1.21,  0.28,  0.13,  0.12,  0.00, -0.11,  0.30,  0.14,  0.17),
    ("silver_gelatin",    "Monochrome",      400,  1.24,  0.26,  0.27,  0.00,  0.00,  0.00,  0.02,  0.04, -0.06,  0.50,  0.00,  0.34),
    ("analog_dream",      "Creative",        200,  0.84,  0.48,  0.72,  0.66,  0.13,  0.02,  0.06, -0.01, -0.05,  0.43,  0.42,  0.02),
    ("cinema_reveal_35",  "MotionNegative",  250,  0.99,  0.23,  0.71,  0.98,  0.00,  0.00,  0.00,  0.01,  0.00,  0.24,  0.08,  0.14),
]
