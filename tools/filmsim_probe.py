...
STOCKS = [
    ...
    ("heritage_gold",     "ColorNegative",   200,  1.07,  0.23,  0.38,  1.13,  0.15, -0.01,  0.07,  0.02, -0.07,  0.24,  0.07,  0.18),
    ("porcelain_400",     "ColorNegative",   400,  0.93,  0.29,  0.58,  0.90,  0.04,  0.02,  0.02,  0.00, -0.02,  0.22,  0.04,  0.11),
    ("vivid_chrome",      "Reversal",         50,  1.30,  0.07,  0.11,  1.40, -0.01,  0.01,  0.00,  0.02, -0.01,  0.10,  0.01,  0.30),
    ("arctic",            "Reversal",        100,  1.17,  0.09,  0.16,  1.17, -0.13, -0.01, -0.06,  0.01,  0.08,  0.14,  0.01,  0.23),
    ("sovereign",         "ColorNegative",   160,  1.05,  0.20,  0.35,  1.05,  0.04,  0.01,  0.02,  0.01, -0.02,  0.18,  0.04,  0.18),
    ("golden_hour",       "ColorNegative",   200,  1.02,  0.25,  0.45,  1.11,  0.22,  0.01,  0.10,  0.03, -0.10,  0.22,  0.09,  0.11),
    ("twilight_160",      "MotionNegative",  160,  0.94,  0.24,  0.64,  0.88, -0.07,  0.00, -0.03,  0.01,  0.06,  0.20,  0.07,  0.09),
    ("nostalgia_200",     "ColorNegative",   200,  0.92,  0.34,  0.52,  0.77,  0.11,  0.05,  0.04,  0.01, -0.05,  0.31,  0.05,  0.07),
    ("desert_chrome",     "Reversal",         64,  1.20,  0.11,  0.15,  1.30,  0.18, -0.03,  0.09,  0.04, -0.10,  0.12,  0.02,  0.25),
    ("street_800",        "ColorNegative",   800,  1.13,  0.31,  0.44,  0.86, -0.01,  0.01, -0.01,  0.01,  0.01,  0.55,  0.05,  0.24),
    ("cinematic_500t",    "MotionNegative",  500,  0.92,  0.26,  0.65,  0.85, -0.11,  0.00, -0.06,  0.00,  0.08,  0.30,  0.25,  0.08),
    ("fade_bloom",        "Creative",        200,  0.79,  0.50,  0.62,  0.68,  0.08,  0.06,  0.04,  0.00, -0.03,  0.39,  0.21,  0.03),
    ("ember",             "Creative",        400,  1.13,  0.22,  0.37,  1.12,  0.23,  0.04,  0.11,  0.01, -0.10,  0.30,  0.14,  0.16),
    ("silver_gelatin",    "Monochrome",      400,  1.22,  0.26,  0.28,  0.00,  0.00,  0.00,  0.02,  0.04, -0.06,  0.48,  0.00,  0.32),
    ("analog_dream",      "Creative",        200,  0.84,  0.43,  0.68,  0.78,  0.09,  0.06,  0.05, -0.01, -0.03,  0.43,  0.19,  0.03),
    ("cinema_reveal_35",  "MotionNegative",  250,  0.96,  0.24,  0.63,  0.94, -0.02,  0.01, -0.01,  0.01,  0.02,  0.24,  0.12,  0.13),
]
