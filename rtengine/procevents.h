...
//    EvPixelShiftMedian3 = 469,
   ...
   // Evlocallabavoid = 590,
    ...
    EvAIDNEnabled = 1150,
    EvAIDNBlend = 1151,
    EvColorGradingEnabled = 1152,
    EvColorGradingShadows = 1153,
    EvColorGradingMidtones = 1154,
    EvColorGradingHighlights = 1155,
    EvColorGradingGlobal = 1156,
    EvColorGradingBlending = 1157,
    EvColorGradingBalance = 1158,
    EvHSVEqMode = 1159,
    EvHSVEqSliders = 1160,
    EvLocallabSpotGradAngle = 1161,
    EvPointColorEnabled = 1162,
    EvPointColorHue = 1163,
    EvPointColorHueShift = 1164,
    EvPointColorSaturation = 1165,
    EvPointColorLuminance = 1166,
