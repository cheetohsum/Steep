...
//    LocallabListener* locallListener;
    ...
    // One-shot: the next pass tail segments regardless of the auto-analyze
    // setting (requestSmartMaskAnalysis). Consumed by the pass that sees it.
    std::atomic<bool> smartMaskAnalysisForced_{false};
